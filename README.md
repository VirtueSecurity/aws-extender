...
* It might be advisable to enable the "Passive Mode" option when testing on production environments in order to avoid any potentially disruptive bucket misconfiguration checks (see: [#4](https://github.com/VirtueSecurity/aws-extender/issues/4)).
